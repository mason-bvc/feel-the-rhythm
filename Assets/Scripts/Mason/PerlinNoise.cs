//
// ported from nowl@github's implementation
...
public static class PerlinNoise
{
    ...
    public static int Noise2(int seed, int x, int y)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static float LinInter(float x, float y, float s)
    {
        return x + s * (y - x);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static float SmoothInter(float x, float y, float s)
    {
    ...
    public static float Perlin2D(int seed, float x, float y, float freq, int depth)
    {
        float xa = x * freq;
        float ya = y * freq;
        float amp = 1.0F;
